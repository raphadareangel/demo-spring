package com.inditext.zara.util;
...
public class PricingMock {
	...
	public static List<Pricing> getData() {
		...
		Product product1 = new Product(2L, "Product 2");
		Product product2 = new Product(3L, "Product 3");
		...
		pricing1.setProducts(productList);
		...
		// Add product to pricing
		pricing2.setProducts(productList);

		// Add pricing to the brand
		brand1.setPrices(pricingList);;
